...
const SingleBlog = ({blog}) => {
    ...
    return (
        <div className='card border-b-2 mb-10'>
            <img src={coverImage} alt="cover image" className='rounded-lg h-[450px] w-full' />
            <div className='flex justify-between items-center mt-8 mb-5'>
                ...
                <div>
                    {readTime} min read <span className='cursor-pointer'><FontAwesomeIcon icon={faBookmark} /></span>
                </div>
            </div>
            <h2 className='text-4xl font-bold mb-7'>{blogTitle}</h2>
            <p className='cursor-pointer text-purple-600 underline mb-10'>Mark as read</p>   
        </div>
    );
};
